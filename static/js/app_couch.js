(() => {
    ...
    Cal.prototype.showMonth = function(y, m) {
        new Date;
        var firstDayOfMonth = new Date(y, m, 7).getDay(), lastDateOfMonth = new Date(y, m + 1, 0).getDate(), lastDayOfLastMonth = 0 == m ? new Date(y - 1, 11, 0).getDate() : new Date(y, m, 0).getDate();
        var html = "<table>";
        html += "<thead><tr>";
        ...
        do {
            ...
            if (0 == dow) html += "</tr>"; else if (i == lastDateOfMonth) {
                k = 1;
                for (dow; dow < 7; dow++) {
                    html += '<td class="not-current">' + k + "</td>";
                    k++;
